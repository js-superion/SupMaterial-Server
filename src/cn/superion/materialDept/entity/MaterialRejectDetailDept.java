...
public class MaterialRejectDetailDept  implements java.io.Serializable {
    ...
    /** default constructor */
    public MaterialRejectDetailDept() {
    }

	/** minimal constructor */
    public MaterialRejectDetailDept(String autoId, String mainAutoId, Short serialNo, String materialClass, String materialId, String materialCode, String materialName) {
        this.autoId = autoId;
	...
	public MaterialRdsDetailDept buildMaterialRdsDetail(){
	...
	/**
	 * 累计报损数量，并修改报损物资的进货和零售金额
	 * @param rejectAmount
	 */
	public void addAmount(Double rejectAmount) {
		amount += rejectAmount;
		if(this.tradePrice != null){
			this.tradeMoney = this.tradePrice * amount;
		}
		if(this.retailPrice != null){
			this.retailMoney = this.retailPrice * amount;
		}
	}
}