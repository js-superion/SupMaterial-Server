...
public class MaterialCheckDetail  implements java.io.Serializable {
    ...
    /** default constructor */
    public MaterialCheckDetail() {
    }

	/** minimal constructor */
    public MaterialCheckDetail(String autoId, String mainAutoId, Short serialNo, String materialClass, String materialId, String materialCode, String materialName) {
        this.autoId = autoId;
	...
	public MaterialRdsDetail buildMaterialRdsDetail(Double diffAmount) {
