...
/**
 * EqNationClassDict entity. @author MyEclipse Persistence Tools
 */

public class EqNationClassDict implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5361457536098614422L;
	...
	/** default constructor */
	public EqNationClassDict() {
	}

	/** minimal constructor */
	public EqNationClassDict(String classCode) {
		this.classCode = classCode;
	}

	/** full constructor */
	public EqNationClassDict(String classCode, String className, String remark,
