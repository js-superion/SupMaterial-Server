...
public class CssdPersonTrainFiles implements java.io.Serializable {
	...
	/** default constructor */
	public CssdPersonTrainFiles() {
	}

	/** minimal constructor */
	public CssdPersonTrainFiles(String autoId, String mainAutoId,
